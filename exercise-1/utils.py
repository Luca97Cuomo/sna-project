...
class Clustering:
    def __init__(self, clustering_algorithm_list, graph, node_to_labels, seed=42, draw_graph=False, verbose=False):
    ...
    def __evaluate(self, clustering_algorithm):
        ...
        clusters = clustering_algorithm(self.graph, self.seed)
