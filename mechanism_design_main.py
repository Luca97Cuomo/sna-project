...
from mid_term.exercise_3.src.classification.combinatorial_truthifier import CombinatorialTruthifier
from mid_term.exercise_3.src.classification.logistic_regression import LogisticRegression
from mid_term.exercise_3.src.classification.linear_regression import LinearRegression
from mid_term.exercise_3.src.classification.neural_network import NeuralNetwork
from mid_term.exercise_3.src.classification.truthifier import Truthifier
from mid_term.exercise_3.src.dataset import generate_random_samples, generate_naive_labels_with_misreporting, generate_naive_labels, \
    generate_labels_using_only_available_features
from mid_term.exercise_3.src.evaluation.accuracy import evaluate_over_all_combinations, mae, categorical_accuracy, mae_std, \
    errors_greater_than_one
from mid_term.exercise_3.src.evaluation.timing import evaluate_fit_time, evaluate_prediction_time
from mid_term.exercise_3.src.evaluation.truthfulness import reviews_subject_to_cheating, ways_of_cheating_reviews
import logging
